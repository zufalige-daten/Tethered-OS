...

{
	...
	source_ext = 'c'
	compiler_command = 'i386-elf-gcc -g -c -m32 -o {output} {input} -I {include} -nostdlib -fno-stack-protector -ffreestanding -O2 -Wall -Wextra -fno-exceptions -masm=intel -Wno-unused-parameter'
}
